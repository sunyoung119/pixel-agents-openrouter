...
바닐라 [Pixel Agents](https://github.com/pixel-agents-hq/pixel-agents)는 Claude Code 세션만 시각화하지만, 이 포크는 **OpenRouter 멀티모델 시각화, 한국어화**를 더했습니다.<br>그러면서 pixel-agents 코어/서버 소스는 한 줄도 수정하지 않았습니다.
